  ...
  final List<Map<String, String>> faqList = [
    {
      ...
      "answer": "To change profile information, go to Settings > Edit Profile Information"
    },
    {
      "question": "How do I start scanning papers?",
      "answer": "Tap the 'scan' icon at the bottom navigation bar to scan exam papers"
    },
    {
      "question": "How do I manage my question scheme?",
      "answer": "Go to Management Page > Exam Management >  Select Class > Click Exam > Click Question > Manage the Schemes"
    },
    {
      "question": "Is my data safe and private?",
      "answer": "Yes. All data is encrypted and only used within the scope of your account settings."
    },
  ];
...
void initState() {
  ...
  elevation: 0,
  leading: IconButton(
    icon: const Icon(Icons.arrow_back, color: Color(0xFF00A5FF)), // blue back icon
          ...
          children: faqList.asMap().entries.map((entry) {
            ...
            return ExpansionPanel(
              ...
              headerBuilder: (_, isExpanded) => Container(
                color: const Color(0xFFF0F8FF), // Light blue for question
                child: ListTile(
                  title: Text(
                    faq["question"]!,
      ...
      child: Container(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            return InkWell(
              onTap: () {
                // TODO: Handle contact method action
              },
              child: Container(
