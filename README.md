...
-Class, student, and examination management

-OCR-based handwritten answer scanning

-Automated grading using marking schemes

-Human verification for low-similarity answers
...
git clone https://github.com/your-username/grading_bot.git
cd grading_bot
flutter pub get
flutter run
